function createPageNavigationButton(direction, link) {
    ...
    if (link) {
        ...
        element.setAttribute("aria-label", isPrevious ? "Previous page" : "Next page");
    } else {
        element.setAttribute("aria-disabled", "true");
        element.setAttribute("aria-label", isPrevious ? "No previous page" : "No next page");
    }
...
function addPageNavigationButtons() {
    ...
    document.body.classList.add("has-page-nav-buttons");

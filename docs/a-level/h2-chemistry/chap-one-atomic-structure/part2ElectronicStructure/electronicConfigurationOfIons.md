...
1. First we find the electronic configuration of N, $1s^2 \, 2s^2 \, 2p^3$
2. Add 3 (since the charge is -3) electrons, starting from the **lowest** energy available subshell which is found to be 2p, so $1s^2 \, 2s^2 \, 2p^6$
